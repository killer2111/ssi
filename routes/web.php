...
Route::post('/enviar', 'GmailController@enviar');
Route::get('/contacto', 'GmailController@vistar');
...
Route::get('/intranet/index', 'HomeController@index')->name('home');
...
Route::post('/producto/confirmar_llegada', 'ProductoController@confirmar_llegada')
->middleware('permission:producto.orden_compra_m');
...
Route::post('/producto/orden_trabajo2/{ID_PRODUCTO}', 'ProductoController@orden_trabajo2')->name('producto.orden_trabajo2')
->middleware('permission:producto.orden_trabajo2');
...
Route::get('/producto/ver_orden_trabajo2/{ID_PRODUCTO}', 'ProductoController@ver_orden_trabajo2')->name('producto.ver_orden_trabajo2') 
->middleware('permission:producto.ver_orden_trabajo2'); 
Route::post('/producto/ver_orden_trabajo2/{ID_PRODUCTO}', 'ProductoController@ver_orden_trabajo2')->name('producto.ver_orden_trabajo2') 
->middleware('permission:producto.ver_orden_trabajo2'); 
...
Route::post('/producto/producto.crear_coti', 'ProductoController@store_pro_coti')
->middleware('permission:producto');
...
//RUTAS PDF
    ...
    ->middleware('permission:pdf_c_pro');

    //PDF General Convenio
    Route::get('/convenio/PDFgeneral/{ID_CONVENIO}', 'ConvenioController@PDFgeneralconvenio')
    ->middleware('permission:convenio.PDFgeneral');
