...
class Cotizacion extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['ID_ORDEN_COMPRA','OBSERVACIONES', 'ID_IVA', 'RUT_CLIENTE', 'DESCRIPCION', 'FECHA_COTIZACION', 'FECHA_LLEGADA', 'FECHA_RESPUESTA_COTIZACION', 'VALOR_NETO', 'VALOR_TOTAL', 'COD_PETICION_OFERTA', 'PORC_DESCUENTO', 'ESTADO'];
