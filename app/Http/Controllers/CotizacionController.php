...
class CotizacionController extends Controller
{
    ...
    public function show( $ID_COTIZACION = null)
    {
        ...
        $producto = \DB::table('cotizacion')
        ->select('producto.ESTADO')
        ->join('detalle_cotizacion','detalle_cotizacion.ID_COTIZACION','=','cotizacion.ID_COTIZACION')
        ...
        return view('cotizacion.show')->with('cotizacion',$cotizacion)->with('orden',$orden)->with('iva',$iva)->with('producto',$producto);
    }
