...
class Producto extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['RUT_CLIENTE','OBSERVACIONES', 'DESCRIPCION', 'COD_PETICION_OFERTA', 'TIPO_PRODUCTO', 'PLANO_PRODUCTO', 'FECHA_LLEGADA', 'FECHA_RESPUESTA_COTIZACION', 'FECHA_DE_ENTREGA_PRODUCTO', 'ESTADO', 'UTILIDADES', 'GASTOS_GENERALES', 'TOTAL','CODIGO_SAP','ESTADO_CONV'];
