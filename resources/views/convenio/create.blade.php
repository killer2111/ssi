			...
			<div class="panel panel-success"style="width:100%;">
					...
					<div class="panel-body">
							<p>
								...
								<p>
									<input type="text" name="fecha_emision"min="{{date('Y-m-d')}}"placeholder="Fecha Emision" class="form-control"onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" id="fecha_emision"  required>
								</p>
								<p>
									<input type="text" name="fecha_inicio" min="{{date('Y-m-d')}}"placeholder="Fecha inicio de convenio" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" id="fecha_inicio" class="form-control" required>
								</p>
								<p>
									<input type="text" name="fecha_final" min="{{date('Y-m-d')}}"placeholder="Fecha final de convenio" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" id="fecha_inicio" class="form-control">
