	...
	<div class="panel panel-success"  margin-top: 20px;">
  		...
  		<div class="panel-body">
				...
				<table class="table table-bordered" style="width:100%;  float:right;">
					...
					<td>
							<a href="/convenio/PDFgeneral/{{$cotizacion->ID_CONVENIO}}"><img src="/images/png/pdf.png" style="width:60px;" alt=""></a>

							<a href="/convenio" class="btn btn-default">Regresar</a></td>
