...
<body >
        ...
        <div class="panel panel-success" style="margin-top:20px;">
                ...
                <form action="{{ route('inventario.update', $inventario->ID_INVENTARIO)}}" method="POST">
                      ...
                      <p>   
                            <strong><h5>Nombre</h6></strong>     <input type="text" name="nombre" value="{{ $inventario->NOMBRE }}" placeholder="Nombre" class="form-control" onkeypress='return validaNumericos(event)' maxlength="20"  required>
                        </p>
                      <p>
                            <strong><h5>Marca</h6></strong>   <input type="text" name="marca" value="{{ $inventario->MARCA }}" placeholder="Marca" maxlength="50" class="form-control" onkeypress='return validar(event)' required>
                      </p>
                      <p><strong><h5>Ubicación</h6></strong>
                        ...
                        <p>
                                <strong><h5>Valor</h6></strong>   <input type="text" name="valor" value="{{ $inventario->VALOR }}" placeholder="Valor" maxlength="9" class="form-control" onkeypress='return validaNumericos(event)' required>
                        </p>
        
                        <p>
                                <strong><h5>Estado</h6></strong>
