		...
		<table class="table " id="tabla_cargos_familiar">
			...
			<table class="table">
					...
					<tr>
						...
						<td><input type="text" name="fecha_inicio_c" min="{{date('Y-m-d')}}"class="form-control" placeholder="Inicio de Contrato" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" required></td>
						<td><input type="text" name="fecha_termino_c" min="{{date('Y-m-d')}}"class="form-control" placeholder="Final de Contrato" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" ></td>
