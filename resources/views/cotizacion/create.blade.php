...
@endif
		...
		<div class="panel panel-success"style="width:100%;">
                ...
                <p>
					<input type="text" max="2099-01-01" min="{{date('Y-m-d')}}"name="fecha_resp_coti" placeholder="Fecha respuesta de cotización" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" id="fecha_llegada" class="form-control" required>
