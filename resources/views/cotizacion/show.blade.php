				...
				<table class="table table-bordered">
					<tbody>
						...
						<tr>
							...
							@if(!empty($cotizacion ->COD_PETICION_OFERTA))
						...
						<tr>
								...
								@if( !empty($producto->ESTADO))


								@if ($producto->ESTADO == 'COTIZADO')

								<td style="text-align:right;"><strong>PDF Cotización:</strong> </td>
								<td><a href="/cotizacion/PDFgeneral/{{$cotizacion->ID_COTIZACION}}"><img src="/images/png/pdf.png" style="width:30px;" alt=""></a></td>
								@endif
								@endif	
