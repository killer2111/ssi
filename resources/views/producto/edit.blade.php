        ...
        <div class="panel panel-success" style="margin-top:20px;">
                ...
                <form action="{{ route('producto.update', $producto->ID_PRODUCTO)}}" method="POST" enctype="multipart/form-data">
                          ...
                          <input name="_method" type="hidden" value="PUT">
                            ...
                            <p>
                                    <strong><h5>Fecha de Entrega</h6></strong>   <input type="text" name="fecha_entrega" value="{{$producto->FECHA_DE_ENTREGA_PRODUCTO}}"placeholder="Fecha entrega producto" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" id="fecha_llegada" class="form-control" required>
                            </p>
                            <p>
                            ...
                            <p>
                                    <strong><h5>Plano</h6></strong> <a href="/producto/subir_plano/{{$producto->ID_PRODUCTO}}" class="btn btn-primary">Subir o Modificar Plano</a>
                               
                            </p>
            
                            <p><strong><h5>Tipo de Producto</h6></strong>
