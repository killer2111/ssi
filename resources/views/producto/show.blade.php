  		...
  		<div class="panel-body">
			...
			<table class="table table-bordered">
				<thead>
					...
					<tr>
					<td>{{$mano_obra->NOMBREP}} {{$mano_obra->APELLIDOP}}</td>
					<td>${{ number_format($mano_obra->H_H, 0, ",", ".") }}</td>
					<td>{{$mano_obra->CANTIDAD_HORAS}}</td>
					<td>${{ number_format($mano_obra->TOTAL_MANO_OBRA, 0, ",", ".") }}</td>
					</tr>	
					@endforeach
				...
				<table class="table table-bordered">
					...
					<table class="table table-bordered">
						<thead>
							...
							<td>${{ number_format($equipo->PRECIO_UNITARIO, 0, ",", ".") }}</td>
							<td>${{ number_format($equipo->VALOR_TOTAL_E, 0, ",", ".") }}</td>
						...
						<table class="table table-bordered">
							<thead>
								...
								<td>${{ number_format($equipoa->VALOR, 0, ",", ".") }}</td>
								<td>${{ number_format($equipoa->VALOR_TOTAL, 0, ",", ".") }}</td>
