					...
					<div class="container-fluid">
					  ...
					  <div  id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav" style="display: inline;">
								@can('producto')
							<li ><a href="/producto/index/{{$ID_COTIZACION->ID_COTIZACION}}">Volver al listado</a></li>
							  @endcan
		...
		<div class="panel panel-success"style="width:100%;">
				...
				@endif
					<p>
						...
						<p>
								<textarea class="form-control" name="observacion" placeholder="Observación" required rows="7" cols="30"></textarea><br />
						...
						<table class="table" id="material">
												...
												<tbody>
													<tr>
														...
														<td><input type="text" name="unidad[]"  placeholder="Unidad" class="form-control unidad" maxlength="50"  required>
														</td>
